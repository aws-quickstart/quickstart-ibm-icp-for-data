...
#   installer.runPlaybook("./playbooks/config-docker.yaml", {'target_nodes': 'worker'})
  ...
  def installICPD(self):
    ...
    with open(logFilePath,"a+") as knownHostsFile:
      ...
      retcode = call(['sudo','/root/icpd_configure.sh', str(self.getMasterIPAddresses()[0]),str(self.getClusterName()),str(self.icpHome)], stdout=knownHostsFile)
  ...
  def main(self,argv):
    ...
    try:
      ...
      TR.info(methodName,"BOOT0101I BEGIN Bootstrap AWS ICP Quickstart version 1.0.0.")
