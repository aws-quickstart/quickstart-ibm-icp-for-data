...
^|https://aws-quickstart.s3.amazonaws.com/quickstart-ibm-icp-for-data/templates/ibm-cloudpak-root.yaml[View template^]

^|https://fwd.aws/6zgYY[Deploy {partner-product-short-name} into an existing VPC on AWS^]
^|https://aws-quickstart.s3.amazonaws.com/quickstart-ibm-icp-for-data/templates/ibm-cloudpak-data.yaml[View template^]
|===
